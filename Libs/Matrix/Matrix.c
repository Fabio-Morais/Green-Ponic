...
void pintaExterior(Room *room, Matrix *matrix)
{
    ...
    if(room->roomName[0].medi[0].allMeasurements[1][0]==1)
    {
        if(room->roomName[0].medi[0].allMeasurements[0][0]<10)
            strcpy(matrix->col[14].l[4].str, cor.corSensTempLOW); //mot1
        else if(room->roomName[0].medi[0].allMeasurements[0][0]<20)
            strcpy(matrix->col[14].l[4].str, cor.corSensTempOK);
        else
            strcpy(matrix->col[14].l[4].str, cor.corSensTempHIGH);
    }
    else
        strcpy(matrix->col[14].l[4].str, cor.corSemMote); //mot1
    /**Humidade**/
    if(room->roomName[0].medi[0].allMeasurements[1][1]==1)
    {
        if(room->roomName[0].medi[0].allMeasurements[0][1]<10)
            strcpy(matrix->col[15].l[4].str, cor.corSensHumLOW); //mot1
        else if(room->roomName[0].medi[0].allMeasurements[0][1]<20)
            strcpy(matrix->col[15].l[4].str, cor.corSensHumOK); //mot1
        else
            strcpy(matrix->col[15].l[4].str, cor.corSensHumHIGH); //mot1
    }
    else
        strcpy(matrix->col[15].l[4].str, cor.corSemMote); //mot1
    /**Ph**/
    if(room->roomName[0].medi[0].allMeasurements[1][2]==1)
    {
        if(room->roomName[0].medi[0].allMeasurements[0][2]<10)
            strcpy(matrix->col[15].l[5].str, cor.corSensPhLOW); //mot1
        else if(room->roomName[0].medi[0].allMeasurements[0][2]<20)
            strcpy(matrix->col[15].l[5].str, cor.corSensPhOK); //mot1
        else
            strcpy(matrix->col[15].l[5].str, cor.corSensPhHIGH);
    }
    else
        strcpy(matrix->col[15].l[5].str, cor.corSemMote);
    /**Light**/
    if(room->roomName[0].medi[0].allMeasurements[1][3]==1)
    {
        if(room->roomName[0].medi[0].allMeasurements[0][3]<10)
            strcpy(matrix->col[14].l[5].str, cor.corSensLightLOW); //mot1
        else if(room->roomName[0].medi[0].allMeasurements[0][3]<20)
            strcpy(matrix->col[14].l[5].str, cor.corSensLightOK); //mot1
        else
            strcpy(matrix->col[14].l[5].str, cor.corSensLightHIGH); //mot1
    }
    else
        strcpy(matrix->col[14].l[5].str, cor.corSemMote);
}
...
{
    /**Temperatura**/
    if(room->roomName[(*indice)].medi[3].allMeasurements[1][0]==1)
    {
        if(room->roomName[(*indice)].medi[3].allMeasurements[0][0]<10)
            strcpy(matrix->col[11].l[7].str, cor.corSensTempLOW); //mot1
        else if(room->roomName[(*indice)].medi[3].allMeasurements[0][0]<20)
    ...
    /**Humidade**/
    if(room->roomName[(*indice)].medi[3].allMeasurements[1][1]==1)
    {
        if(room->roomName[(*indice)].medi[3].allMeasurements[0][1]<10)
            strcpy(matrix->col[12].l[7].str, cor.corSensHumLOW); //mot1
        else if(room->roomName[(*indice)].medi[3].allMeasurements[0][1]<20)
    ...
    /**Ph**/
    if(room->roomName[(*indice)].medi[3].allMeasurements[1][2]==1)
    {
        if(room->roomName[(*indice)].medi[3].allMeasurements[0][2]<10)
            strcpy(matrix->col[12].l[8].str, cor.corSensPhLOW); //mot1
        else if(room->roomName[(*indice)].medi[3].allMeasurements[0][2]<20)
    ...
    /**Light**/
    if(room->roomName[(*indice)].medi[3].allMeasurements[1][3]==1)
    {
        if(room->roomName[(*indice)].medi[3].allMeasurements[0][3]<10)
            strcpy(matrix->col[11].l[8].str, cor.corSensLightLOW); //mot1
        else if(room->roomName[(*indice)].medi[3].allMeasurements[0][3]<20)
...
void mot43(Matrix *matrix, Room *room, int *indice)
{
    ...
    if(room->roomName[(*indice)].medi[3].allMeasurements[1][1]==1)
    {
        if(room->roomName[(*indice)].medi[3].allMeasurements[0][1]<10)
            ...
            strcpy(matrix->col[7].l[12].str, cor.corSensHumHIGH); //mot1
    }
    else
...
{
    if(room->roomName[0].countActuador == 0)
    {
        /*pinta cor de fundo no sitio dos sensores*/

    }
    else if(room->roomName[0].countActuador == 1)
    {
        if(!strcmp(room->roomName[0].ActuadorName[0], "FAN"))
        {
            strcpy(matrix->col[19].l[10].str, cor.corExisteAtuador);
            if(room->roomName[0].ActuadorOnOff[0]==1)
            {
                strcpy(matrix->col[19].l[10].str, cor.verde); //fan
            }
            else strcpy(matrix->col[19].l[10].str, cor.vermelho);  //fan

        }
        else if(!strcmp(room->roomName[0].ActuadorName[1], "HEATER"))
        {
            strcpy(matrix->col[20].l[10].str, cor.corExisteAtuador);
            if(room->roomName[0].ActuadorOnOff[1]==1)
            {
                strcpy(matrix->col[20].l[10].str, cor.verde); //fan
            }
            else strcpy(matrix->col[20].l[10].str, cor.vermelho);

        }
        else if(!strcmp(room->roomName[0].ActuadorName[2], "LIGHT"))
        {
            strcpy(matrix->col[19].l[11].str, cor.corExisteAtuador); //fan
            if(room->roomName[0].ActuadorOnOff[2]==1)
            {
                strcpy(matrix->col[19].l[11].str, cor.verde); //fan
            }
            else strcpy(matrix->col[19].l[11].str, cor.vermelho);  //fan

        }
        else if(!strcmp(room->roomName[0].ActuadorName[3], "ELECTROVALVE"))
        {
            strcpy(matrix->col[20].l[11].str, cor.corExisteAtuador); //fan
            if(room->roomName[0].ActuadorOnOff[3]==1)
            {
                strcpy(matrix->col[20].l[11].str, cor.verde); //fan
            }
            else strcpy(matrix->col[20].l[11].str, cor.vermelho);  //fan
        }
    }
    else if(room->roomName[0].countActuador == 2)
    {
        for(int i=0; i<room->roomName[0].countActuador; i++)
        {
            if(!strcmp(room->roomName[0].ActuadorName[i], "FAN"))
            {
                strcpy(matrix->col[19].l[10].str, cor.corExisteAtuador);
                if(room->roomName[0].ActuadorOnOff[0]==1)
                {
            ...
            else if(!strcmp(room->roomName[0].ActuadorName[i], "HEATER"))
            {
                ...
                else strcpy(matrix->col[20].l[10].str, cor.vermelho);  //fan

            }
            else if(!strcmp(room->roomName[0].ActuadorName[i], "LIGHT"))
            {
                strcpy(matrix->col[19].l[11].str, cor.corExisteAtuador); //fan
                if(room->roomName[0].ActuadorOnOff[2]==1)
                {
            ...
            else if(!strcmp(room->roomName[0].ActuadorName[i], "ELECTROVALVE"))
            {
                strcpy(matrix->col[20].l[11].str, cor.corExisteAtuador); //fan
                if(room->roomName[0].ActuadorOnOff[3]==1)
                {
    ...
    else if(room->roomName[0].countActuador == 3)
    {
        for(int i=0; i<room->roomName[0].countActuador; i++)
        {
            if(!strcmp(room->roomName[0].ActuadorName[i], "FAN"))
    ...
    else if(room->roomName[0].countActuador == 4)
    {
        for(int i=0; i<room->roomName[0].countActuador; i++)
        {
            if(!strcmp(room->roomName[0].ActuadorName[i], "FAN"))
...
{
    if(room->roomName[1].countActuador == 0)
    {
        /*pinta cor de fundo no sitio dos sensores*/

    }
    else if(room->roomName[1].countActuador == 1)
    {
        if(!strcmp(room->roomName[1].ActuadorName[1], "FAN"))
        {
            strcpy(matrix->col[18].l[21].str, cor.corExisteAtuador);
            if(room->roomName[1].ActuadorOnOff[0]==1)
            {
                strcpy(matrix->col[18].l[21].str, cor.verde); //fan
            }
            else strcpy(matrix->col[18].l[21].str, cor.vermelho); //fan

        }
        else if(!strcmp(room->roomName[1].ActuadorName[1], "HEATER"))
        {
            strcpy(matrix->col[19].l[21].str, cor.corExisteAtuador);  //fan
            if(room->roomName[1].ActuadorOnOff[1]==1)
            {
                strcpy(matrix->col[19].l[21].str, cor.verde); //fan
            }
            else strcpy(matrix->col[19].l[21].str, cor.vermelho); //fan

        }
        else if(!strcmp(room->roomName[1].ActuadorName[2], "LIGHT"))
        {
            strcpy(matrix->col[18].l[22].str, cor.corExisteAtuador);  //fan
            if(room->roomName[1].ActuadorOnOff[2]==1)
            {
                strcpy(matrix->col[18].l[22].str, cor.verde); //fan
            }
            else strcpy(matrix->col[18].l[22].str, cor.vermelho); //fan

        }
        else if(!strcmp(room->roomName[1].ActuadorName[3], "ELECTROVALVE"))
        {
            strcpy(matrix->col[19].l[22].str, cor.corExisteAtuador);  //fan
            if(room->roomName[1].ActuadorOnOff[3]==1)
            {
                strcpy(matrix->col[19].l[22].str, cor.verde); //fan
            }
            else strcpy(matrix->col[19].l[22].str, cor.vermelho); //fan
        }
    }
    else if(room->roomName[1].countActuador == 2)
    {
        for(int i=0; i<room->roomName[1].countActuador; i++)
        {
            if(!strcmp(room->roomName[1].ActuadorName[i], "FAN"))
            {
                strcpy(matrix->col[18].l[21].str, cor.corExisteAtuador);
                if(room->roomName[1].ActuadorOnOff[0]==1)
                {
            ...
            else if(!strcmp(room->roomName[1].ActuadorName[i], "HEATER"))
            {
                strcpy(matrix->col[19].l[21].str, cor.corExisteAtuador);  //fan
                if(room->roomName[1].ActuadorOnOff[1]==1)
                {
            ...
            else if(!strcmp(room->roomName[1].ActuadorName[i], "LIGHT"))
            {
                strcpy(matrix->col[18].l[22].str, cor.corExisteAtuador);  //fan
                if(room->roomName[1].ActuadorOnOff[2]==1)
                {
            ...
            else if(!strcmp(room->roomName[1].ActuadorName[i], "ELECTROVALVE"))
            {
                strcpy(matrix->col[19].l[22].str, cor.corExisteAtuador);  //fan
                if(room->roomName[1].ActuadorOnOff[3]==1)
                {
    ...
    else if(room->roomName[1].countActuador == 3)
    {
        for(int i=0; i<room->roomName[1].countActuador; i++)
        {
            if(!strcmp(room->roomName[1].ActuadorName[i], "FAN"))
    ...
    else if(room->roomName[1].countActuador == 4)
    {
        for(int i=0; i<room->roomName[1].countActuador; i++)
        {
            if(!strcmp(room->roomName[1].ActuadorName[i], "FAN"))
...
{
    if(room->roomName[2].countActuador == 0)
    {
        /*pinta cor de fundo no sitio dos sensores*/

    }
    else if(room->roomName[2].countActuador == 1)
    {
        if(!strcmp(room->roomName[2].ActuadorName[1], "FAN"))
        {
            strcpy(matrix->col[9].l[21].str, cor.corExisteAtuador);
            if(room->roomName[2].ActuadorOnOff[0]==1)
            {
                strcpy(matrix->col[9].l[21].str, cor.verde); //fan
            }
            else strcpy(matrix->col[9].l[21].str, cor.vermelho); //fan

        }
        else if(!strcmp(room->roomName[2].ActuadorName[1], "HEATER"))
        {
            strcpy(matrix->col[10].l[21].str, cor.corExisteAtuador);  //fan
            if(room->roomName[2].ActuadorOnOff[1]==1)
            {
                strcpy(matrix->col[10].l[21].str, cor.verde); //fan
            }
            else strcpy(matrix->col[10].l[21].str, cor.vermelho); //fan

        }
        else if(!strcmp(room->roomName[2].ActuadorName[2], "LIGHT"))
        {
            strcpy(matrix->col[9].l[22].str, cor.corExisteAtuador);  //fan
            if(room->roomName[2].ActuadorOnOff[2]==1)
            {
                strcpy(matrix->col[9].l[22].str, cor.verde); //fan
            }
            else strcpy(matrix->col[9].l[22].str, cor.vermelho); //fan

        }
        else if(!strcmp(room->roomName[2].ActuadorName[3], "ELECTROVALVE"))
        {
            strcpy(matrix->col[10].l[22].str, cor.corExisteAtuador);  //fan
            if(room->roomName[2].ActuadorOnOff[3]==1)
            {
                strcpy(matrix->col[10].l[22].str, cor.verde); //fan
            }
            else strcpy(matrix->col[10].l[22].str, cor.vermelho); //fan
        }
    }
    else if(room->roomName[2].countActuador == 2)
    {
        for(int i=0; i<room->roomName[2].countActuador; i++)
        {
            if(!strcmp(room->roomName[2].ActuadorName[i], "FAN"))
            {
                strcpy(matrix->col[9].l[21].str, cor.corExisteAtuador);
                if(room->roomName[2].ActuadorOnOff[0]==1)
                {
            ...
            else if(!strcmp(room->roomName[2].ActuadorName[i], "HEATER"))
            {
                strcpy(matrix->col[10].l[21].str, cor.corExisteAtuador);  //fan
                if(room->roomName[2].ActuadorOnOff[1]==1)
                {
            ...
            else if(!strcmp(room->roomName[2].ActuadorName[i], "LIGHT"))
            {
                strcpy(matrix->col[9].l[22].str, cor.corExisteAtuador);  //fan
                if(room->roomName[2].ActuadorOnOff[2]==1)
                {
            ...
            else if(!strcmp(room->roomName[2].ActuadorName[i], "ELECTROVALVE"))
            {
                strcpy(matrix->col[10].l[22].str, cor.corExisteAtuador);  //fan
                if(room->roomName[2].ActuadorOnOff[3]==1)
                {
    ...
    else if(room->roomName[2].countActuador == 3)
    {
        for(int i=0; i<room->roomName[2].countActuador; i++)
        {
            if(!strcmp(room->roomName[2].ActuadorName[i], "FAN"))
    ...
    else if(room->roomName[2].countActuador == 4)
    {
        for(int i=0; i<room->roomName[2].countActuador; i++)
        {
            if(!strcmp(room->roomName[2].ActuadorName[i], "FAN"))
...
{
    if(room->roomName[3].countActuador == 0)
    {
        /*pinta cor de fundo no sitio dos sensores*/

    }
    else if(room->roomName[3].countActuador == 1)
    {
        if(!strcmp(room->roomName[3].ActuadorName[1], "FAN"))
        {
            strcpy(matrix->col[9].l[9].str, cor.corExisteAtuador);
            if(room->roomName[3].ActuadorOnOff[0]==1)
            {
                strcpy(matrix->col[9].l[9].str, cor.verde); //fan
            }
            else strcpy(matrix->col[9].l[9].str, cor.vermelho); //fan

        }
        else if(!strcmp(room->roomName[3].ActuadorName[1], "HEATER"))
        {
            strcpy(matrix->col[10].l[9].str, cor.corExisteAtuador);  //fan
            if(room->roomName[3].ActuadorOnOff[1]==1)
            {
                strcpy(matrix->col[10].l[9].str, cor.verde); //fan
            }
            else strcpy(matrix->col[10].l[9].str, cor.vermelho); //fan

        }
        else if(!strcmp(room->roomName[3].ActuadorName[3], "LIGHT"))
        {
            strcpy(matrix->col[9].l[10].str, cor.corExisteAtuador);  //fan
            if(room->roomName[3].ActuadorOnOff[2]==1)
            {
                strcpy(matrix->col[9].l[10].str, cor.verde); //fan
            }
            else strcpy(matrix->col[9].l[10].str, cor.vermelho); //fan

        }
        else if(!strcmp(room->roomName[3].ActuadorName[3], "ELECTROVALVE"))
        {
            strcpy(matrix->col[10].l[10].str, cor.corExisteAtuador);  //fan
            if(room->roomName[3].ActuadorOnOff[3]==1)
            {
                strcpy(matrix->col[10].l[10].str, cor.verde); //fan
            }
            else strcpy(matrix->col[10].l[10].str, cor.vermelho); //fan
        }
    }
    else if(room->roomName[3].countActuador == 2)
    {
        for(int i=0; i<room->roomName[3].countActuador; i++)
        {
            if(!strcmp(room->roomName[3].ActuadorName[i], "FAN"))
            {
                strcpy(matrix->col[9].l[9].str, cor.corExisteAtuador);
                if(room->roomName[3].ActuadorOnOff[0]==1)
                {
            ...
            else if(!strcmp(room->roomName[3].ActuadorName[i], "HEATER"))
            {
                strcpy(matrix->col[10].l[9].str, cor.corExisteAtuador);  //fan
                if(room->roomName[3].ActuadorOnOff[1]==1)
                {
            ...
            else if(!strcmp(room->roomName[3].ActuadorName[i], "LIGHT"))
            {
                strcpy(matrix->col[9].l[10].str, cor.corExisteAtuador);  //fan
                if(room->roomName[3].ActuadorOnOff[2]==1)
                {
            ...
            else if(!strcmp(room->roomName[3].ActuadorName[i], "ELECTROVALVE"))
            {
                strcpy(matrix->col[10].l[10].str, cor.corExisteAtuador);  //fan
                if(room->roomName[3].ActuadorOnOff[3]==1)
                {
    ...
    else if(room->roomName[3].countActuador == 3)
    {
        for(int i=0; i<room->roomName[3].countActuador; i++)
        {
            if(!strcmp(room->roomName[3].ActuadorName[i], "FAN"))
    ...
    else if(room->roomName[3].countActuador == 4)
    {
        for(int i=0; i<room->roomName[3].countActuador; i++)
        {
            if(!strcmp(room->roomName[3].ActuadorName[i], "FAN"))
