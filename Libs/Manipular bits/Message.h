...
typedef struct{
    ...
    /*  |    0       |     1    | 2  |  3   | -> INDICE
        |temperature | humidity | ph | light| -> VALORES DE MEDIÇOES DE CADA SENSOR
        |  1/0       |    1/0   | 1/0|  1/0 | -> 1 ON, 0 OFF   ,  indica se é para incluir o sensor ou nao7
    */
...
/*
Toma as decisões para qual Room vai colocar (RoomName, Sensores, Atuadores)
...
allMeasurements[0][n] contem os valores das mediçoes recebeidas no fgets
...
/*  Coloca as mediçoes na struct Medicoes
    Coloca 0/1 para saber se o sensor DAQUELA MOT é para usar ou nao
*/
